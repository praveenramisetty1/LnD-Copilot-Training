...
| REQ-03 | Semantic caching (cosine ≥ 0.95, TTL 7d) | UC-02 | TC-03 | `src/cache/semantic_cache.py`, `src/cache/embedding_service.py` | Caching & Cost (20%) |
...
| REQ-08 | Conversational analytics interface (NLU queries) | UC-07 | TC-07 | `src/analytics/chat_interface.py` | Analytics (10%) |
...
| UC-07 Conversational Analytics | TC-07 (NLU queries 07-03 to 07-06) |
...
| TC-07: Analytics & NLU | Analytics & Conversational Interface | 10% |
...
| Analytics | REQ-07, REQ-08 | UC-06, UC-07 | TC-07 | ✅ Fully Traced |
